be_define_const_str(dot_len, ".len", 850842136u, 0, 4, &be_const_str_contains);
...
be_define_const_str(dot_p, ".p", 1171526419u, 0, 2, &be_const_str_iter);
be_define_const_str(iter, "iter", 3124256359u, 0, 4, NULL);
be_define_const_str(__lower__, "__lower__", 123855590u, 0, 9, &be_const_str_escape);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_pow);
be_define_const_str(pow, "pow", 1479764693u, 0, 3, NULL);
be_define_const_str(classof, "classof", 1796577762u, 0, 7, &be_const_str_map);
be_define_const_str(map, "map", 3751997361u, 0, 3, &be_const_str_type);
be_define_const_str(type, "type", 1361572173u, 0, 4, &be_const_str_true);
be_define_const_str(true, "true", 1303515621u, 61, 4, NULL);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_setmember);
be_define_const_str(setmember, "setmember", 1432909441u, 0, 9, &be_const_str_tr);
be_define_const_str(tr, "tr", 1195724803u, 0, 2, NULL);
be_define_const_str(upper, "upper", 176974407u, 0, 5, NULL);
be_define_const_str(bytes, "bytes", 1706151940u, 0, 5, &be_const_str_find);
be_define_const_str(find, "find", 3186656602u, 0, 4, &be_const_str_rad);
be_define_const_str(rad, "rad", 1358899048u, 0, 3, &be_const_str_setbits);
...
be_define_const_str(opt_connect, "..", 2748622605u, 0, 2, &be_const_str_acos);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_concat);
be_define_const_str(concat, "concat", 4124019837u, 0, 6, &be_const_str_fromb64);
be_define_const_str(fromb64, "fromb64", 2717019639u, 0, 7, &be_const_str_input);
be_define_const_str(input, "input", 4191711099u, 0, 5, &be_const_str_size);
be_define_const_str(size, "size", 597743964u, 0, 4, &be_const_str_else);
be_define_const_str(else, "else", 3183434736u, 52, 4, NULL);
be_define_const_str(rand, "rand", 2711325910u, 0, 4, &be_const_str_set);
be_define_const_str(set, "set", 3324446467u, 0, 3, &be_const_str_import);
be_define_const_str(import, "import", 288002260u, 66, 6, &be_const_str_while);
be_define_const_str(while, "while", 231090382u, 53, 5, NULL);
be_define_const_str(cosh, "cosh", 4099687964u, 0, 4, &be_const_str_exp);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_nan);
...
be_define_const_str(asin, "asin", 4272848550u, 0, 4, &be_const_str_floor);
be_define_const_str(floor, "floor", 3102149661u, 0, 5, NULL);
be_define_const_str(opt_neq, "!=", 2428715011u, 0, 2, &be_const_str_deinit);
be_define_const_str(deinit, "deinit", 2345559592u, 0, 6, NULL);
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, NULL);
be_define_const_str(imin, "imin", 2714127864u, 0, 4, &be_const_str_list);
be_define_const_str(list, "list", 217798785u, 0, 4, &be_const_str_seti);
be_define_const_str(seti, "seti", 1500556254u, 0, 4, &be_const_str_except);
be_define_const_str(except, "except", 950914032u, 69, 6, &be_const_str_for);
be_define_const_str(for, "for", 2901640080u, 54, 3, NULL);
be_define_const_str(load, "load", 3859241449u, 0, 4, &be_const_str_lower);
...
be_define_const_str(dot_size, ".size", 1965188224u, 0, 5, &be_const_str_if);
be_define_const_str(if, "if", 959999494u, 50, 2, NULL);
be_define_const_str(__upper__, "__upper__", 3612202883u, 0, 9, &be_const_str_fromptr);
be_define_const_str(fromptr, "fromptr", 666189689u, 0, 7, &be_const_str_hex);
...
be_define_const_str(__iterator__, "__iterator__", 3884039703u, 0, 12, &be_const_str_tolower);
be_define_const_str(tolower, "tolower", 1042520049u, 0, 7, &be_const_str_raise);
...
be_define_const_str(opt_eq, "==", 2431966415u, 0, 2, &be_const_str_push);
be_define_const_str(push, "push", 2272264157u, 0, 4, &be_const_str_tob64);
be_define_const_str(tob64, "tob64", 373777640u, 0, 5, NULL);
be_define_const_str(bool, "bool", 3365180733u, 0, 4, &be_const_str_split);
...
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_reverse);
...
be_define_const_str(number, "number", 467038368u, 0, 6, &be_const_str_false);
be_define_const_str(false, "false", 184981848u, 62, 5, NULL);
be_define_const_str(call, "call", 3018949801u, 0, 4, &be_const_str_real);
be_define_const_str(real, "real", 3604983901u, 0, 4, &be_const_str_str);
...
be_define_const_str(break, "break", 3378807160u, 58, 5, &be_const_str_end);
be_define_const_str(end, "end", 1787721130u, 56, 3, NULL);
be_define_const_str(int, "int", 2515107422u, 0, 3, &be_const_str_do);
be_define_const_str(do, "do", 1646057492u, 65, 2, NULL);
be_define_const_str(open, "open", 3546203337u, 0, 4, NULL);
be_define_const_str(as, "as", 1579491469u, 67, 2, &be_const_str_class);
be_define_const_str(class, "class", 2872970239u, 57, 5, NULL);
be_define_const_str(opt_call, "()", 685372826u, 0, 2, &be_const_str_fromstring);
...
be_define_const_str(geti, "geti", 2381006490u, 0, 4, &be_const_str_tanh);
be_define_const_str(tanh, "tanh", 153638352u, 0, 4, &be_const_str_toupper);
be_define_const_str(toupper, "toupper", 3691983576u, 0, 7, &be_const_str_def);
be_define_const_str(def, "def", 3310976652u, 55, 3, NULL);
be_define_const_str(byte, "byte", 1683620383u, 0, 4, &be_const_str_sin);
be_define_const_str(sin, "sin", 3761252941u, 0, 3, &be_const_str_tan);
be_define_const_str(tan, "tan", 2633446552u, 0, 3, &be_const_str_tostring);
be_define_const_str(tostring, "tostring", 2299708645u, 0, 8, &be_const_str_try);
be_define_const_str(try, "try", 2887626766u, 68, 3, NULL);
be_define_const_str(clear, "clear", 1550717474u, 0, 5, &be_const_str_sinh);
...
be_define_const_str(allocated, "allocated", 429986098u, 0, 9, &be_const_str_static);
be_define_const_str(static, "static", 3532702267u, 71, 6, NULL);
be_define_const_str(pi, "pi", 1213090802u, 0, 2, NULL);
be_define_const_str(atan2, "atan2", 3173440503u, 0, 5, &be_const_str_remove);
be_define_const_str(remove, "remove", 3683784189u, 0, 6, NULL);
be_define_const_str(opt_add, "+", 772578730u, 0, 1, &be_const_str_assert);
be_define_const_str(assert, "assert", 2774883451u, 0, 6, NULL);
be_define_const_str(path, "path", 2223459638u, 0, 4, &be_const_str_continue);
be_define_const_str(continue, "continue", 2977070660u, 59, 8, NULL);
be_define_const_str(atan, "atan", 108579519u, 0, 4, &be_const_str_compile);
be_define_const_str(compile, "compile", 1000265118u, 0, 7, &be_const_str_log10);
...
be_define_const_str(init, "init", 380752755u, 0, 4, &be_const_str_members);
be_define_const_str(members, "members", 937576464u, 0, 7, NULL);
be_define_const_str(resize, "resize", 3514612129u, 0, 6, NULL);
be_define_const_str(format, "format", 3114108242u, 0, 6, &be_const_str_get);
...
be_define_const_str(collect, "collect", 2399039025u, 0, 7, &be_const_str_cos);
be_define_const_str(cos, "cos", 4220379804u, 0, 3, &be_const_str_isnan);
